...
const sendMail = (to, url, txt) => {
    ...
    const mailOptions = {
        ...
        html: `
            ...
            <h2 style="text-align: center; text-transform: uppercase;color: teal;">Welcome to Point of Sale.</h2>
            <p>Congratulations! You're almost set to start using Point of Sale.
